    ...
    <div class="col-12">
        <div class="ibox ">
            <div class="ibox-title p-3 d-flex justify-content-between align-items-center bg-pattern">
                ...
                <div>
                    <a href="{{ route('jabatan.create') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus mr-1"></i>
                        Tambah Jabatan</a>
                </div>
            </div>
            <div class="ibox-content">
                <div class="table-responsive">
                    <table id="data-jabatan" class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Nama</th>
